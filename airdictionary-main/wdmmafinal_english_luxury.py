                    ...
                    <div class="logo-column">
                        {% for idx in range(3) %}
                            ...
                            {% if logo_exists(left_files[idx]) %}
                                <div class="logo-slot" style="padding:8px;"><img src="{{ url_for('static', filename='logos/' ~ left_files[idx]) }}" alt="{{ left_files[idx] }}" style="max-width:100%;max-height:58px;object-fit:contain;"></div>
                            {% else %}
                                <div class="logo-slot">US Armed Forces Logo {{ idx + 1 }}<br>left slot</div>
                            {% endif %}
                        {% endfor %}
                    </div>
                    ...
                    <div class="logo-column">
                        {% for idx in range(3) %}
                            ...
                            {% if logo_exists(right_files[idx]) %}
                                <div class="logo-slot" style="padding:8px;"><img src="{{ url_for('static', filename='logos/' ~ right_files[idx]) }}" alt="{{ right_files[idx] }}" style="max-width:100%;max-height:58px;object-fit:contain;"></div>
                            {% else %}
                                <div class="logo-slot">US Armed Forces Logo {{ idx + 4 }}<br>right slot</div>
                            {% endif %}
                        {% endfor %}
                    </div>
                </div>
